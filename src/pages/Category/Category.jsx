...
export default function Category() {
  ...
  useEffect(() => {
    const fetchCourses = async () => {
      try {
        console.log("Fetching courses for category:", categoryName);
        ...
        if (!Array.isArray(allCourses)) {
          console.error("دریافت داده با فرمت نادرست:", allCourses);
          return;
        }
    ...
    if (categoryName) {
      ...
      console.warn("categoryName is empty or invalid:", categoryName);
    }
  }, [categoryName]); 
